...
// 4. Тест прав дилерского реестра
console.log("\n4. Проверка реестра ведущих «Атмосферы»:");
const registry = POKER_CONFIG.DEALERS_REGISTRY;
assert.strictEqual(registry.MAP["h0raiz0n"], "Влад");
assert.strictEqual(registry.MAP["unknown_user"], undefined);
console.log("   ✅ Белый список ведущих работает корректно.");
