...
assert(swCode.includes("const CACHE = 'atmos-v10'") || swCode.includes("const CACHE = 'atmos-v17'") || swCode.includes("const CACHE = 'atmos-v18'") || swCode.includes("const CACHE = 'atmos-v19'") || swCode.includes("const CACHE = 'atmos-v20'") || swCode.includes("const CACHE = 'atmos-v21'") || swCode.includes("const CACHE = 'atmos-v22'") || swCode.includes("const CACHE = 'atmos-v23'") || swCode.includes("const CACHE = 'atmos-v24'") || swCode.includes("const CACHE = 'atmos-v25'") || swCode.includes("const CACHE = 'atmos-v26'") || swCode.includes("const CACHE = 'atmos-v27'") || swCode.includes("const CACHE = 'atmos-v28'") || swCode.includes("const CACHE = 'atmos-v29'") || swCode.includes("const CACHE = 'atmos-v30'") || swCode.includes("const CACHE = 'atmos-v31'") || swCode.includes("const CACHE = 'atmos-v32'") || swCode.includes("const CACHE = 'atmos-v33'") || swCode.includes("const CACHE = 'atmos-v34'") || swCode.includes("const CACHE = 'atmos-v35'") || swCode.includes("const CACHE = 'atmos-v36'") || swCode.includes("const CACHE = 'atmos-v37'") || swCode.includes("const CACHE = 'atmos-v38'") || swCode.includes("const CACHE = 'atmos-v39'") || swCode.includes("const CACHE = 'atmos-v40'") || swCode.includes("const CACHE = 'atmos-v41'") || swCode.includes("const CACHE = 'atmos-v42'") || swCode.includes("const CACHE = 'atmos-v43'"), "sw.js должен использовать актуальную версию кэша atmos-v43");
