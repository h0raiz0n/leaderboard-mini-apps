...
assert(swCode.includes("const CACHE = 'atmos-v10'") || swCode.includes("const CACHE = 'atmos-v17'") || swCode.includes("const CACHE = 'atmos-v18'") || swCode.includes("const CACHE = 'atmos-v19'") || swCode.includes("const CACHE = 'atmos-v20'"), "sw.js должен использовать актуальную версию кэша atmos-v20");
