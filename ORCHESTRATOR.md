...
#### [ ] TASK-11.3. Автоматический транзит уровней блайндов и звуковое оповещение
* **Что делаем:** По истечении времени уровня (`now >= levelEndsAt`) автоматически переключать раунд на следующий без ручного участия дилера. Добавить встроенный Web Audio Chime на ТВ.
* **Файлы:** `dealer/dealer.js`, `tv/tv.js`

#### [ ] VERIFY-11.3. Тест автоперехода уровней без участия дилера
* **Проверка:** Автотест `tests/test_auto_level_progression.js`.
