...
#### [ ] TASK-11.4. Редизайн ТВ-дашборда по стандартам Impeccable (1, 2, 3, 4 стола)
* **Что делаем:** Полная ликвидация пустого пространства. Максимизация таймера, текущих и следующих блайндов для 1 (Hero Billboard), 2 (Split Screen), 3 (Triple Pillar) и 4 (Quad 2x2) столов.
* **Файлы:** `tv/styles.css`, `tv/tv.js`

#### [ ] VERIFY-11.4. Визуальный E2E тест 4K ТВ-дашборда
* **Проверка:** Автотест `tests/test_tv_impeccable_layouts.js`.
